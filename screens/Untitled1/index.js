...
const Untitled1 = () => {
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      }}><View style={styles.poKeUevT}></View></Pressable><Text style={styles.FYGUTjBJ}>{"rest cis achamhrm u"}</Text><View style={styles.JNfsSYiS}></View><ImageBackground style={styles.iXmigFiI} source={{
      ...
      }} resizeMode="cover"></ImageBackground><TextInput style={styles.HAifiUJo}></TextInput></ScrollView>
    </SafeAreaView>;
};
